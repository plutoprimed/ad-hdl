...
set_property PACKAGE_PIN N14 [get_ports iic_sda]
...
set_property -dict {PACKAGE_PIN K13 IOSTANDARD LVCMOS18} [get_ports sweep_check]
set_property -dict {PACKAGE_PIN M12 IOSTANDARD LVCMOS18} [get_ports sync]
